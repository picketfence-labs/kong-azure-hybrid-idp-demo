...
[![kong-azure-obo-demo アーキテクチャ概要](assets/obo/obo-overview.png)](https://picketfence-labs.github.io/diagrams/27298e53d910/)

*画像クリックでインタラクティブ版（パン/ズーム・テーマ切替）を開く（[picketfence-labs/diagrams](https://github.com/picketfence-labs/diagrams)、GitHub Pagesで配信。ソースは[docs/assets/obo/obo-overview.architecture.json](assets/obo/obo-overview.architecture.json)、[Archify](https://github.com/tt-a1i/archify)で生成）。Group 1はフォーク元から変更していないため、フォーク元[kong-azure-obo-demo](https://github.com/picketfence-labs/kong-azure-obo-demo)が2026-09にmermaid図からArchify図へ更新したものをそのまま取り込んでいます。*
...
[![OBOトークン交換フロー](assets/obo/obo-token-exchange-flow.png)](https://picketfence-labs.github.io/diagrams/aba73733596b/)

*画像クリックでインタラクティブ版（パン/ズーム・テーマ切替）を開く（[picketfence-labs/diagrams](https://github.com/picketfence-labs/diagrams)、GitHub Pagesで配信。ソースは[docs/assets/obo/obo-token-exchange-flow.sequence.json](assets/obo/obo-token-exchange-flow.sequence.json)、[Archify](https://github.com/tt-a1i/archify)で生成）。*
...
- [Custom-Plugin.md](./Custom-Plugin.md) — Group 2（ADFS）のOIDC認証・カスタムプラグイン認可の解説。本書のGroup 1と対になるドキュメント
